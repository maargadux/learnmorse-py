# 🌌 Morse Code Trainer 🗝️
#### *Decode. Feel. Transcend.*

---

## 🎨 Project Essence | Essência do Projeto

**English:**  
Morse Code Trainer is more than a program — it’s an **experience in rhythm and perception**.  
Every dot (`.`) and dash (`-`) becomes a pulse of thought, a tiny secret hidden in plain sight.  
It invites learners to **engage, experiment, and explore patterns** while coding, blending logic and creativity.

**Português:**  
O Treinador de Código Morse é mais que um programa — é uma **experiência de ritmo e percepção**.  
Cada ponto (`.`) e traço (`-`) é um pulso de pensamento, um pequeno segredo à vista de todos.  
Convida quem aprende a **interagir, experimentar e explorar padrões**, misturando lógica e criatividade.
...
Input: Type letters, numbers, and spaces.
Translation: Each character is converted to its Morse code equivalent (. for dot, - for dash).
Output: The program prints the translation with spaces between letters.
Feedback: Unknown characters are replaced with ? for easy learning.
